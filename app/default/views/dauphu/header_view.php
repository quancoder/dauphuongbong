...
<html>
    <head lang="en">
        ...
        <link href="<?php echo base_url() . "skins/" . ltrim(URI_PATH . '/', '/') . $template_f; ?>font-awesome4.7/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
         <script type="text/javascript" src="<?php echo base_url(); ?>js/<?php echo ltrim(URI_PATH . '/', '/') . $template_f; ?>jquery-3.3.1.min.js"></script>
    ...
    <body>
        <div id="modal-mobile" class="modal-mb modal-mb-on">
            
            <a class="modal-esc" role="button" href="javascript:void(0)">
                <i class="fa fa-times" aria-hidden="true"></i>
            </a>
            <ul class="navmenu-centent-mb">
