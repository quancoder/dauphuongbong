<div id="SECTION384" class="widget-section ladi-drop ui-droppable" lp-type="widget_section" lp-widget="widget"
     lp-lang="SECTION" lp-display="block">
    <div class="container">
        <div id="IMAGE398" class="widget-element widget-snap ladi-drop" lp-type="image" lp-lang="IMAGE"
             lp-display="block">
        ...
        <div id="GROUP389" class="widget-element widget-snap widget-group" lp-type="widget_group" lp-lang="GROUP"
             lp-display="block">
            <div class="widget-content">
                <div id="HEADLINE390" class="widget-element widget-snap" lp-type="textinline" lp-editor="true"
                     lp-lang="HEADLINE" lp-group="GROUP389" lp-display="block"><p class="widget-content"
                                                                             lp-node="p"><span
                            style="font-weight: bold;">CÔNG TY TNHH THỰC PHẨM SẠCH ABC</span><br>Địa chỉ: Số 9 Phúc
                            Minh, Phúc Diễn, Bắc Từ Liêm, Hà Nội<br>Hotline: <a target="_blank"
                                    ...
                                    988</a><br>Email: lienhe@dauphuongbong.vn<br>Website: <a target="_blank"
                                        ...
                                        <div id="GROUP391" class="widget-element widget-snap widget-group" lp-type="widget_group"
                                            ...
                                            <div class="widget-content">
                                                <div id="SHAPE392" class="widget-element widget-snap" lp-type="shape" lp-lang="SHAPE"
                                                     lp-group="GROUP391" lp-display="block"
                                                     lp-action-link="https://www.facebook.com/DauphuOngBong/" lp-action-type="url"
                                                     lp-target="_blank" onclick="onClick(this, event)" style="cursor: pointer;">
                                                    <div class="widget-content">
                                                ...
                                                <div id="SHAPE393" class="widget-element widget-snap" lp-type="shape" lp-lang="SHAPE"
                                                     lp-group="GROUP391" lp-display="block">
                                                    <div class="widget-content">
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                                             width="100%" height="100%" viewBox="0 0 24 24" fill="rgba(255,255,255,1)">
                                                ...
                                                <div id="SHAPE394" class="widget-element widget-snap" lp-type="shape" lp-lang="SHAPE"
                                                     lp-group="GROUP391" lp-display="block">
                                                    <div class="widget-content">
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                                             width="100%" height="100%" viewBox="0 0 24 24" fill="rgba(255,255,255,1)">
                                        ...
                                        <div id="PARAGRAPH289" class="widget-element widget-snap" lp-type="textparagraph" lp-editor="true"
                                             lp-lang="PARAGRAPH" lp-display="block"><h6 class="widget-content" lp-node="h6">Kết nối với chúng
                                                tôi</h6></div>
                                        </div>
                                        <div class="ladi-widget-overlay"></div>
                                        </div>
