...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?=base_url()?>/admin_source/dist/img/logo-ongbong-1528177613.png">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="<?=base_url()?>/admin_source/dist/img/logo-ongbong-1528177613.png" class="user-image" alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="<?=base_url()?>/admin_source/dist/img/logo-ongbong-1528177613.png" class="img-circle" alt="User Image">
